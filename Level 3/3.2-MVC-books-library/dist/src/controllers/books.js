...
exports.setDeletedBook = exports.addBook = exports.getBook = exports.getBooks = void 0;
...
var getBooks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                booksData = _a.sent();
                return [2 /*return*/, res.render('books-page/books', {
...
var getBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var bookData, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, books_1.getBookService)(req.params.id)];
            case 1:
                bookData = _a.sent();
...
var addBook = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, books_1.addBookImageService)()];
            case 1:
                upload = _a.sent();
                upload.single('bookImage')(req, res, function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, books_1.addBookService)(req.body)];
                            case 1:
                                _a.sent();
...
var setDeletedBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, (0, books_1.setDeletedBookService)(id)];
            case 1:
                _a.sent();
...
exports.setDeletedBook = setDeletedBook;
