...
export class UpdateFilmEntity1673370366203 implements MigrationInterface {
    name = 'UpdateFilmEntity1673370366203'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`film\` ADD \`release_date\` varchar(255) NOT NULL`);
