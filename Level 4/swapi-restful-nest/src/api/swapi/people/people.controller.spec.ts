...
describe('PeopleController', () => {
  ...
  const mockPeopleService = {
    ...
    addImages: jest.fn().mockImplementation((person, images) => ({
      ...person,
      publicImages: getFakePersonWithId(person.id).publicImages.concat(getFakePublicImages()),
      fileImages: getFakePersonWithId(person.id).fileImages.concat(getFakeFileImages())
    })),
    addRelations: jest.fn().mockImplementation((person, relations) => person),
    removeRelations: jest.fn().mockImplementation((person, relations) => person)
  }
  ...
  it('should get people by page', async () => {
    ...
    expect(await controller.getPeopleByPage(page, count)).toEqual(getFakePeopleByPage(page, count));
  ...
  it('should create a person', async () => {
    ...
    expect(await controller.createPerson(getFakeCreatePersonDto(), getFakeFiles())).toEqual({
